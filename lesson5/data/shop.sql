...
--
-- Хост: localhost
-- Время создания: Мар 02 2021 г., 12:57
...
INSERT INTO `comments` (`id`, `product_id`, `user_name`, `text`, `comment_date`) VALUES
(10, 1, 'Денис', 'dfsdfsdf', 1614420024),
(11, 11, 'Денис', 'test', 1614487910),
(14, 1, 'Den', 'adfgsfsdf', 1614671310),
(15, 2, 'Den', 'test', 1614671355);
...
(3, 'Корзина', 'cart', NULL, 3, NULL),
(6, 'Регистрация', 'register', 3, NULL, NULL),
(7, 'Вход', 'login', 4, NULL, NULL),
...
(33, 'Den', '$2y$10$L5QOFMzxZee/60wgmwjY/uxUzSc7fBqEswnJo6gxrtJQKyUzOkp92', 1614682933, '2009122238603e1b359cec46.99463901', NULL);
