...
--
-- Хост: localhost
-- Время создания: Мар 16 2021 г., 14:25
...
(10, 'На главную магазина', 'home', NULL, NULL, NULL),
(11, 'Выход', 'admin/logout', NULL, NULL, 1);
...
INSERT INTO `users` (`id`, `login`, `password`, `reg_date`, `buyer_id`, `remember`, `role_id`) VALUES
(2, 'admin', '$2y$10$/UL5zUY5R07Q4D1Bkc9u5.mTuA.ZCmEFnWgxG.bZrFh5OPZAkezji', 1613359900, NULL, NULL, 2),
(24, 'Den', '$2y$10$7zL9y2vPkSxfOwRA9klJae60UJXfDAFet3YYIaofrNVVjCt/ndRSW', 1615889037, 'dbf3c38716a624725ee3d7ac87f9b20e', NULL, 1),
(35, 'Ivan', '$2y$10$Te4d1IaSzuTE2Kh9tpVuoOUGl35xxIfoDGqU8JU7nRuAOKi1sdxeK', 1615900349, '5b178b9d2eec189775515da93d9ab4d0', NULL, 1);
